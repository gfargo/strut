...
_usage_keys() {
  ...
  echo ""
  echo "Registry:"
  echo "  rotate-registry [--registry <url>] [--hosts all|h1,h2] [--username <u>]"
  echo "                   [--revoke-old] [--dry-run]   Rotate pull credentials"
  echo "  registry-status [--registry <url>] [--hosts all|h1,h2] [--json]"
  echo "                                                 Show login state per host"
  echo ""
  echo "GitHub:"
